...
function applyStatusColors() {
    document.querySelectorAll(".status-dropdown").forEach(select => {
        ...
        select.addEventListener("change", function () {
            ...
            // Here you could add AJAX call to save status to database
            // saveStatusToDatabase(this.dataset.index, this.value);
        });
    });
}
...
function saveStatusToDatabase(inquiryIndex, newStatus) {
    // You can implement this to save status changes without page reload
