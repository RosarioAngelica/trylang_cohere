...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeHistory() {
        ...
        addToHistory('login', 'Admin logged in', 'Successful login to admin dashboard');
        addToHistory('system', 'Profile page loaded', 'Admin profile page accessed');
        
        // Load history from storage if available (in real implementation)
        displayHistory();
        updateHistoryStats();
    }
    ...
    logoutBtn.addEventListener('click', function() {
        ...
        showConfirmModal('Confirm Logout', 'Are you sure you want to logout? You will be redirected to the login page.', () => {
            // Add logout activity
            addToHistory('login', 'Admin logged out', 'Logged out from admin dashboard');
